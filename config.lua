    ...
    jobs = {
        legal = {
            [0] = {
                ...
                itemRewards = {
                    {35, "plastic", math.random(50,60)},
                    {35, "rubber", math.random(50,60)},
                    {35, "scrapmetal", math.random(50,60)},
                    {35, "electronic_parts", math.random(50,60)},
                    {35, "copperwire", math.random(50,60)},
                    {35, "glue", math.random(50,60)},
                    {35, "ironbar", math.random(50,60)},
                    {35, "heavy_glue", math.random(50,60)},
                },
                dropoffLocations = {
            ...
            [2] = {
                ...
                itemRewards = {
                    {60, "chicken", math.random(12,15)},
                    {60, "beef", math.random(12,15)},
                    {60, "pork", math.random(12,15)},
                    {60, "venison", math.random(12,15)},
                    {60, "unk_meat", math.random(6,9)},
                },
                dropoffLocations = {
            ...
            [4] = {
                ...
                itemRewards = {
                    {60, "beer", math.random(12,15)},
                    {60, "whiskey", math.random(12,15)},
                    {60, "rum", math.random(12,15)},
                    {60, "wine_bottle", math.random(12,15)},
                    {60, "vodka", math.random(12,15)},
                    {60, "tequila", math.random(12,15)},
                },
                dropoffLocations = {
            ...
            [6] = {
                ...
                itemRewards = {
                    ...
                    {45, "apples", math.random(12,15)},
                    {45, "grapes", math.random(12,15)},
                    {45, "blueberries", math.random(12,15)},
                    {25, "weed_bud", math.random(12,15)},
                },
                dropoffLocations = {
        ...
        illegal = {
            [3] = {
                ...
                itemRewards = {
                    {50, "weed_bud", math.random(5,7)},
                    {50, "oxy", math.random(2,3)},
                    {50, "weed_joint", math.random(12,15)},
                    {20, "meth_bag", math.random(2,3)},
                    {20, "coke_bag", math.random(2,3)},
